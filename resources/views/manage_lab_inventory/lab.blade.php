  ...
  <div class="card">
    ...
    <div class="card-body p-0">
      <div class="table-responsive">
        <a href="/manage_lab_inventory/create" class="btn btn-primary mb-3">Tambah</a>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>            
              <a href="/manage_lab_inventory/{{ $inventory->id }}/edit" class="badge bg-warning"><i class="bi bi-pencil-square"></i></a>
              <form action="/manage_lab_inventory/{{ $inventory->id }}" method="POST" class="d-inline">
                @method('delete')
                @csrf
